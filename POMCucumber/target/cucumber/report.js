...
formatter.match({
  "location": "LoginPageSteps.user_is_on_ums_loginpage()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "LoginPageSteps.user_enters_login_details()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "LoginPageSteps.user_clicks_on_Sign_in_button()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "LoginPageSteps.user_lands_on_dashboard_page()"
});
formatter.result({
  "status": "skipped"
});
